...
function Project({ project, index }) {
  ...
  return (
    <article className={"project " + (index % 2 ? "reverse" : "")}>
      <button
        className={"project-image " + (open ? "open" : "")}
      ...
      >
        ...
        <div className="project-overlay">
          ...
          <span>{open ? "Tap to close" : "Hover / tap for details"}</span>
        </div>
      </button>
      {content}
    </article>
    ...
    <div>
      <header>
        ...
        <nav className={menu ? "show" : ""}>
          {["about", "projects", "skills", "journey", "contact"].map((x) => (
      ...
      <main id="top">
        <section className="hero">
          <div className="hero-copy">
            <p className="eyebrow">SADARAM RAHUL · PORTFOLIO</p>
            <h1>
              {profile.name}
              <br />
              <em>BACKEND</em>
        ...
        <section id="about" className="about section">
          ...
          <div>
            <h2>
              Quietly building the
              <br />
              <span>systems behind</span> the screen.
            </h2>
            <p>{profile.about}</p>
          </div>
        </section>
          ...
          <section id="journey" className="section">
            ...
            <div className="timeline">
              {[
                ...
                ...education.map((x) => ({ ...x, type: "Education" })),
                ...certifications.map((x) => ({ ...x, type: "Certification" })),
                ...achievements.map((x) => ({ ...x, type: "Achievement" })),
              ].map((x, i) => (
        ...
        <section id="contact" className="contact section">
          ...
          <div>
            ...
            <p>
              For projects, collaborations, or just a good technical
              conversation.
            </p>
      ...
      <footer>
        <span>SADARAM RAHUL</span>
        <span>BACKEND DEVELOPER · {new Date().getFullYear()}</span>
      </footer>
    </div>
  );
}
